...
HD_PWD='C:/Users/klin/Desktop/LGA/LGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spiControl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spiControl.tcl
